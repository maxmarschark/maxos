...
alter table public.brand_products add column if not exists product_name text not null default '';
alter table public.brand_products add column if not exists sku text not null default '';
alter table public.brand_products add column if not exists category text not null default '';
alter table public.brand_products add column if not exists distributor_price numeric(12, 2) not null default 0;
alter table public.brand_products add column if not exists wholesale_price numeric(12, 2) not null default 0;
alter table public.brand_products add column if not exists msrp numeric(12, 2) not null default 0;
alter table public.brand_products add column if not exists commission_override numeric(5, 2);
alter table public.brand_products add column if not exists notes text not null default '';
